...
class TestQEngine(TestCase):
    ...
    def test_instance_generate_multif_answer(self):
        """ Convert some html templates + variables into resulting instance HTML
    ...
    def test_instance_generate_multiv_answer(self):
        """ Convert some html templates + variables into resulting instance HTML
            and make sure it's doing it right. Focus on multif choice "ANSWER"
    ...
    def test_instance_generate_listbox_answer(self):
        """ Convert some html templates + variables into resulting instance HTML
    ...
    def test_instance_generate_multi_answer(self):
        """ Convert some html templates + variables into resulting instance HTML
    ...
    def test_instance_generate_variable(self):
        """ Convert some html templates + variables into resulting instance HTML
    ...
    def test_html_esc(self):
        ...
        self.assertEqual("&amp;", General.htmlesc("&"))
        self.assertEqual("&lt;", General.htmlesc("<"))
        self.assertEqual("&gt;", General.htmlesc(">"))
    ...
    def test_date_ops(self):
        ...
        self.assertTrue(General.is_between(a, c, b))
    ...
    def test_script_funcs(self):
        ...
        """
        # always right
        self.assertTrue(script_funcs.within_tolerance("3.429", 3.429, 100))
        self.assertTrue(script_funcs.within_tolerance("3.429", 3.429, 10))
        self.assertTrue(script_funcs.within_tolerance("3.429", 3.429, 5))
        self.assertTrue(script_funcs.within_tolerance("3.429", 3.429, 1))
        self.assertTrue(script_funcs.within_tolerance("3.429", 3.429, 0.1))

        self.assertFalse(script_funcs.within_tolerance("3.429", -3.429, 100))
        self.assertFalse(script_funcs.within_tolerance(3.429, -3.429, 1))
        self.assertTrue(script_funcs.within_tolerance(3.429, 9, 100))
