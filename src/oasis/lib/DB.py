...
def clean_install_3_6():
    ...
    with open(os.path.join(OaConfig.homedir, "sql", "emptyschema_36x.sql")) as f:
        sql = f.read()
...
def clean_install_3_9_1():
    ...
    with open(os.path.join(OaConfig.homedir, "sql", "emptyschema_391.sql")) as f:
        sql = f.read()
...
def clean_install_3_9_2():
    ...
    with open(os.path.join(OaConfig.homedir, "sql", "emptyschema_392.sql")) as f:
        sql = f.read()
...
def clean_install_3_9_3():
    ...
    with open(os.path.join(OaConfig.homedir, "sql", "emptyschema_393.sql")) as f:
        sql = f.read()
...
def clean_install_3_9_4():
    ...
    with open(os.path.join(OaConfig.homedir, "sql", "emptyschema_394.sql")) as f:
        sql = f.read()
...
def upgrade_3_6_to_3_9_5(options):
    ...
    """
    with open(os.path.join(OaConfig.homedir, "sql", "migrate_36x_to_392.sql")) as f:
        sql = f.read()
