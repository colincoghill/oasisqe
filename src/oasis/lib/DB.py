...
def upgrade_db():
    ...
    # TODO: Get migration out of code? South? What if we need to run
    ...
    if dbver == "3.6":
        log(FATAL, "Old database will need to be migrated manually!")
        raise ValueError("Old database will need to be migrated manually!")
