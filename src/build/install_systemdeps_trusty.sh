...
echo "Installing dependencies for OASIS on Ubuntu Trusty" >> /tmp/provision.notes
...
sed -i '/trusty-backports/{s/^/#/}' /etc/apt/sources.list
...
echo "Ubuntu Trusty System Dependencies installed"
